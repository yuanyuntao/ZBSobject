<template>
  <div id="calendar">
    ...
    <ul class="days">
      ...
      <li class="dayslists" v-for="dayobject in days" style="height: 120px;" :key="dayobject.id">
        <!--本月-->
        <!--如果不是本月  改变类名加灰色-->
        <template v-if="dayobject.day.getMonth()+1 != currentMonth" class="other-month">
        ...
        <!--显示剩余多少数量-->
        <!-- <template v-if="leftobj[dayobject.index]">
          <p>
            剩余：
