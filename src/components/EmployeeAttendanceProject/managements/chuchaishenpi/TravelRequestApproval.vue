<template>
  <div class="travelRequestApproval" ref="travelRequestApproval">
...
export default {
  ...
  methods: {
    ...
    goBack() {
      ...
      this.$router.push({
        path: "/management",
        query: {
          pagename: "travelRequestApproval"
        }
      });
    },
    //待审批
    ...
    getListData() {
      ...
      var content = {
        ...
        bNum: 0, //从第几条开始
        rows: 20, //查询条数
        bt: localStorage.getItem("travelRequeststartTime")==null||localStorage.getItem("travelRequeststartTime")==""?this.getTIME(this.nowtime, 7):localStorage.getItem("travelRequeststartTime"), //开始时间
        et: localStorage.getItem("travelRequestendTime")==null||localStorage.getItem("travelRequestendTime")==""?this.getTIME(this.nowtime, 4):localStorage.getItem("travelRequestendTime"), //结束时间
        applicatUserId: localStorage.getItem("travelRequestApplicatUserId")==null?"":localStorage.getItem("travelRequestApplicatUserId"),
        approved: localStorage.getItem("travelRequestapproved")=="true"?true:false
      };
    ...
    changeFixed(clientHeight) {
      //动态修改样式
      this.$refs.travelRequestApproval.style.height = clientHeight + "px";
    }
  },
  mounted() {
     if (localStorage.getItem("travelRequestapproved") == "true") {
  ...
  created() {
    ...
    if (this.$route.query.pagename == "travelRequestDetails") {
      localStorage.setItem("travelRequestApproved", false);
    }
  ...
  watch: {
    ...
    clientHeight: function() {
      this.totalHeight = this.$refs.travelRequestApproval.offsetHeight;
