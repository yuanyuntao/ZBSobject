...
<template>
  <div class="outRequestScreening" ref="outRequestScreening">
    <div
      type="primary"
      round
...
export default {
  ...
  methods: {
    ...
    sure() {
      localStorage.setItem("outRequeststartTime", this.startTime);
      localStorage.setItem("outRequestendTime", this.endTime);
      localStorage.setItem("outRequestApplicantUserId", this.applicantUserId);
      this.$router.push({
        path: "/" + this.form,
        query: {
          pagename: "outRequestScreening"
  ...
  created: function() {
    ...
    _this.startTime = localStorage.getItem("outRequeststartTime")==null?"":localStorage.getItem("outRequeststartTime");
    _this.endTime = localStorage.getItem("outRequestendTime")==null?"":localStorage.getItem("outRequestendTime");
    _this.applicantUserId = localStorage.getItem("outRequestApplicantUserId")==null?"":localStorage.getItem("outRequestApplicantUserId");
  }
};
</script>
<style scoped>
