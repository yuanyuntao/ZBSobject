...
export default {
  ...
  methods: {
    ...
    sure() {
      ...
      localStorage.setItem("outRequestApplicatUserId", this.applicatUserId);
      this.$router.push({
        path: "/" + this.form,
        query: {
          pagename: "outRequestScreening"
  ...
  created: function() {
    ...
    _this.applicatUserId = localStorage.getItem("outRequestApplicatUserId")==null?"":localStorage.getItem("outRequestApplicatUserId");
  }
};
</script>
<style scoped>
