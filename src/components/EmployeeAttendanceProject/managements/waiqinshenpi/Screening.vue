...
export default {
  ...
  methods: {
    ...
    sure() {
      ...
      localStorage.setItem("applicatUserId", this.applicatUserId);
      this.$router.push({
        path: "/" + this.form,
        query: {
          pagename: "screening"
  ...
  created: function() {
    ...
    _this.applicatUserId = localStorage.getItem("applicatUserId")==null?"":localStorage.getItem("applicatUserId");
  }
};
</script>
<style scoped>
